...
def select_elements_starting_with_a(array)
  a_elem = []
  array.each{|elem| a_elem << elem if elem[0] == 'a'}
  return a_elem
end
...
def select_elements_starting_with_vowel(array)
  v_elem = []
  array.each{|elem| v_elem << elem  if elem[0][/[aeiou]/] != nil }
  return v_elem
end
...
def every_possible_pairing_of_students(array)
  array.permutation(2).to_a.delete_if{|elem| elem == elem.sort}
end
...
def separate_array_into_even_and_odd_numbers(array)
  array = [array.select{|elem| elem.even?}, array.select{|elem| !elem.even?}]
end
...
def number_of_elements_that_are_palindromes(array)
  numbers = array.select!{|elem| elem == elem.reverse}.length
end
...
def average_of_array(array)
  num = array.inject(){|num, memo| memo =  (memo + num).to_f}
  (num / array.length).ceil
end
